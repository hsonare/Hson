...
$(function () {
    ...
    $.ajax({
        ...
        res.forEach(el => {
            ...
            console.log(current);
            template += `<ul class="order_lists">
        <li class="list_chk">
            <input type="checkbox" id="checkbox_${current[0].id}" class="son_check">
            <label for="checkbox_${current[0].id}"></label>
        </li>
        <li class="list_con">
            <div class="list_img"><a href="javascript:;"><img src="./${picture[0].src}" alt=""></a></div>
            <div class="list_text"><a href="javascript:;">${el.title}</a></div>
        </li>
        <li class="list_info">
            <p>规格：默认</p>
            <!--<p>尺寸：16*16*3(cm)</p>--!>
        ...
        <li class="list_price">
            <p class="price">￥${parseFloat(el.price).toFixed(2)}</p>
        </li>
        <li class="list_amount">
            <div class="amount_box">
                <a href="javascript:;" class="reduce reSty">-</a>
                <input type="text" value="${current[0].num}" class="sum">
                <a href="javascript:;" class="plus">+</a>
            </div>
        </li>
        <li class="list_sum">
            <p class="sum_price">￥${(el.price * current[0].num).toFixed(2)}</p>
        </li>
        <li class="list_op">
            <p class="del"><a href="javascript:;" class="delBtn" data-id="${el.id}">移除商品</a></p>
        </li>
    </ul>`
            // }
        });

        $('.cartBox').html(template);
